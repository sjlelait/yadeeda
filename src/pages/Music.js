...
const Music = (props) => {
    return (
        <div className="content bg-white rounded shadow-lg md:m-30 md:mr-26 md:ml-26">
            <div className="text-xl md:text-3xl font-bold font-homeP text-ydPurple underline">
            ...
            <div className="overflow-hidden">
                ...
                <div className="grid gridMV grid-cols-1 md:grid-cols-2 lg:grid-cols-2 md:mt-38 gap-4 md:mt-20 md:gap-x-0">
                    ...
                    <Link to="/espadrilles" className="flex flex-col items-center mb-4">
                        ...
                        <h3 className="text-xl pt-2 font-semibold">Adult Music</h3>
                    </Link>
                </div>
            </div>            
