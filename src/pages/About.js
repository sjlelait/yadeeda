...
const About = (props) => {
    return (
        <div>
            <h1 className="mb-3 mt-16 text-lg md:text-xl lg:text-3xl font-bold font-homeP text-ydPurple">Yadeeda and Alain Le Lait</h1>
            <div className="flex flex-col md:flex-row">
                ...
                <div className="mt-10 p-4 md:w-1/2 sm:mt-4">
                    <h3>Top 10 Reasons to use our Songs and Videos</h3>
                    <ul className="text-left">
                        ...
                        <li className="mb-2">6.  Great reviews!</li>
                        <li className="mb-2">7.  Used in schools worldwide</li>
                        <li className="mb-2">8.  Illustrated videos with lyrics in the featured language + English translation</li>
